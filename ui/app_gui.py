...
class NaverAutoGUI:
    ...
    def _create_widgets(self):
        ...
        # 1. 로그인 섹션 (왼쪽)
        login_frame = ttk.LabelFrame(top_frame, text="네이버 로그인", padding="10")
        ...
        self.log_text = ScrolledText(log_frame, height=27, width=100, wrap=tk.WORD)
